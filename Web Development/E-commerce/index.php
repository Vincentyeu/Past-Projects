			...
			<div class="container">
				<div class="row">
						...
						<div id="myCarousel" class="carousel slide" data-ride="carousel">
						  ...
						  <div class="carousel-inner">
						    <div class="item active">
						      <img src="img/1(1).jpg" alt="image1"width="100%" height="450px">
						    </div>

						    <div class="item">
						      <img src="img/2(2).jpeg" alt="image2"width="100%" height="450px">
						    </div>

						    <div class="item">
						      <img src="img/3(3).jpeg" alt="image3"width="100%" height="450px">
						    </div>
						    <div class="item">
						      <img src="img/4(4).jpeg" alt="image4"width="100%" height="450px">
						    </div>
						    <div class="item">
						      <img src="img/5(5).png" alt="image5"width="100%" height="450px">
						    </div>
						  </div>
					...
					<div class="col-md-12">
						...
						<h2 style="line-height:100px; font-size:60px; color:rgba(148, 9, 9, 0.958); font-family:italic;"><b>Shop here<b></h2>
							...
							<div id="shop-mason" class="shop-mason-4col">
								...
								<div class="sm-item isotope-item">
									<div class="product">
										...
										<h2 class="product-title"><a href="single.php?id=<?php echo $row['id']; ?>"><?php echo $row['name'];?></a></h2>
										<div class="product-price">RM<?php echo $row['price'];?><!-- <span><?php echo $row['price'];?></span> --></div>
									</div>
								</div>
								<?php
									}
